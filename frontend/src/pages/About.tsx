    ...
    <>
      ...
      <section className="relative overflow-hidden" style={{ paddingTop: 120, paddingBottom: 80 }}>
        <div className="container relative" style={{ zIndex: 2 }}>
          ...
          <motion.p initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.16 }} className="t-body text-center mx-auto mt-5" style={{ maxWidth: 620, color: 'var(--text-secondary)' }}>
            RagexAI is an AI-first digital engineering firm. We help startups and enterprises ship AI-powered platforms, scalable web systems, and data solutions that last.
          </motion.p>
        </div>
      </section>
        ...
        <div className="container">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
            <div className="glass-image">
              <img src="/RagexAI-website/images/about/team.jpg" alt="RagexAI Team" className="w-full h-72 lg:h-96 object-cover" loading="lazy" />
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-14">
            ...
            <p className="t-body mx-auto mt-4" style={{ maxWidth: 520, color: 'var(--text-secondary)' }}>Where we're headed and why it matters</p>
          </motion.div>
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <div className="glass-card p-10 text-center" style={{ maxWidth: 720, margin: '0 auto' }}>
      ...
      <section className="section">
        <div className="container">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-14">
            ...
            <p className="t-body mx-auto mt-4" style={{ maxWidth: 520, color: 'var(--text-secondary)' }}>The people behind RagexAI</p>
          </motion.div>
          <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-40px' }} className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {LEADERSHIP.map((person, i) => (
              <motion.div key={person.name} custom={i} variants={fadeUp} className="glass-card p-7">
                <div className="w-14 h-14 rounded-2xl flex items-center justify-center text-xl font-bold mb-5" style={{ background: 'rgba(26,86,196,0.08)', border: '1px solid rgba(26,86,196,0.12)', color: 'var(--blue)' }}>
                  {person.name.charAt(0)}
                </div>
                <h3 className="t-h3 mb-1">{person.name}</h3>
                <p style={{ fontSize: 12, fontWeight: 600, color: 'var(--blue)', marginBottom: 10, letterSpacing: '0.02em' }}>{person.role}</p>
      ...
      <section className="section">
        <div className="container">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-14">
            ...
            <p className="t-body mx-auto mt-4" style={{ maxWidth: 520, color: 'var(--text-secondary)' }}>What sets RagexAI apart</p>
          </motion.div>
        ...
        <div className="container" style={{ maxWidth: 700 }}>
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="glass-card p-12 text-center">
            ...
            <p className="t-body mx-auto mb-8" style={{ maxWidth: 480, color: 'var(--text-secondary)' }}>
              We're always looking for talented engineers and designers to join the team.
            </p>
